#
#  Be sure to run `pod spec lint HNStorage.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HNStorage"
  spec.version      = "0.5.0"
  spec.summary      = "HNStorage works as a layer to be a simple, efficient, and extendable CRUD layer for different iOS Storing options."
  ...
  spec.homepage     = "https://github.com/HadiIOS/HNStorage"
  ...
  spec.source_files  = "HNStorage/src/**/*.{h,m,swift}"
